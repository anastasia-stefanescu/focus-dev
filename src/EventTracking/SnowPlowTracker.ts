...
export class mySnowPlowTracker {
    ...
    private setTrackingEvents() {
        // this.trackFileEvents(); // save, close files => see what was changed? otherwise we don't need to track them
        ...
        // actual typing; copy, pasting (verify what was copied was pasted)
        // extract comments
